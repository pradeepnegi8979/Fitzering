...
export const SevenSignalsSection: React.FC = () => {
  ...
  const cards: BentoCard[] = [
    ...
    },
    {
      ...
      description: 'See how your heart responds to activity, rest and recovery.',
    ...
    },
    {
      ...
      description: 'A deeper look at how your body is recovering and adapting.',
...
>
 ...
 <div className="cta-btn-wrapper text-center">
  <a href="https://shop.fitze.ae/" target="_blank" rel="noopener noreferrer" className="premium-dark-btn">

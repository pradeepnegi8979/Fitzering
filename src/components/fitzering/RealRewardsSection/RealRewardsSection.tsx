      ...
      <Container>
            ...
            <Col md={4} xs={12} className="stat-column border-right-md text-center">
              <div className="stat-card-inner">
                <div className="stat-main-number">
                  <span className="coral-prefix">AED</span> 1,240
                </div>
        ...
        <div className="rewards-bottom-cta text-center">
          <p className="cta-disclaimer-text">
            No luck. No competition. <span className="highlight-coral-bold">Just consistency, rewarded.</span>
          </p>
          <div className="cta-btn-wrapper">
            <a href="javascript:void(0);" className="premium-dark-btn">
              Shop fitze Ring <span className="btn-arrow-coral">➔</span> 699
            </a>
          </div>
        </div>

          ...
          <Col lg={5} md={12} className="footer-links-col">
            ...
            <div className="footer-download-section">
              ...
              <div className="footer-badges-container d-flex flex-wrap gap-2">
                {/* App Store Badge */}
                <a href="https://apps.apple.com/us/app/fitze/id1497718755" className="custom-app-badge-btn" aria-label="Download on the App Store">
                ...
                {/* Google Play Badge */}
                <a href="https://play.google.com/store/apps/details?id=com.fitze" className="custom-app-badge-btn" aria-label="Get it on Google Play">
                  {/* <div className="badge-icon-left">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                ...
                {/* AppGallery Badge */}
                <a href="https://appgallery.huawei.com/#/app/C102494237" className="custom-app-badge-btn" aria-label="Explore it on AppGallery">
                  {/* <div className="badge-icon-left">
        ...
        <Row className="footer-bottom-row align-items-center">
          ...
          <Col lg={5} md={12} sm={12} className="text-center d-flex justify-content-between mb-md-4 mb-lg-0">
            ...
            <div className="footer-cutout-social-links d-flex gap-2">
              ...
              <a href="https://www.instagram.com/fitzeuae" target="_blank" rel="noopener noreferrer" className="social-cutout-btn" aria-label="Instagram">
